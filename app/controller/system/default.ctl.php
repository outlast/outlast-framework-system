	...
	class zajapp_system extends zajController{
		...
		function javascript_error(){
			// Check if logging is enabled
				if(empty($GLOBALS['zaj_jserror_log_enabled']) || empty($GLOBALS['zaj_jserror_log_file'])) return $this->zajlib->ajax('not logged');
			// Defaults
			...
			// Now write to javascript error log
				file_put_contents($GLOBALS['zaj_jserror_log_file'], $intro.$errordata, FILE_APPEND);
			// Return ok
