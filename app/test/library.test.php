<?php
    ...
    class OfwLibraryTest extends zajTest {
        ...
        public function system_library_array() {
            // Test array merge
            $narray = $this->zajlib->array->merge([1, 2, 3], [4]);
            zajTestAssert::areIdentical(count($narray), 4);
            $narray = $this->zajlib->array->merge([1, 2, 3], '');
        ...
        public function system_library_file() {
            ...
            zajTestAssert::areIdentical($this->zajlib->basepath.'system/site/img/outlast-framework-logo.png',
                $file_path);
            ...
            $download = $this->zajlib->file->download('system/site/img/outlast-framework-logo.png', 'asdf.png',
                'test-mime');
            zajTestAssert::isArray($download);
            list($file_path, $download_name, $mime_type) = $download;
            zajTestAssert::areIdentical($this->zajlib->basepath.'system/site/img/outlast-framework-logo.png',
        ...
        public function system_library_security() {
            ...
            $res = $this->zajlib->security->ip_in_range('199.59.148.209', ['199.59.148.123', '199.59.148.209']);
            zajTestAssert::isTrue($res);
            $res = $this->zajlib->security->ip_in_range('199.59.148.209', ['127.0.0.1']);
        ...
        public function system_library_text() {
            ...
            zajTestAssert::areIdentical('5'.$locale_info['decimal_point'].'5', $res);
