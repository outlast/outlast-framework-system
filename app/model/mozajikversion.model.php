<?php
    ...
    class MozajikVersion extends zajModel {
        ...
        public static function check() {
            ...
            if (!is_object(zajLib::me()->version) || MozajikVersion::$major > zajLib::me()->version->major || MozajikVersion::$minor > zajLib::me()->version->minor) {
                return 0;
            }
            // if db is too new (less likely) return 1
            if (MozajikVersion::$major < zajLib::me()->version->major || MozajikVersion::$minor < zajLib::me()->version->minor) {
                return -1;
            }
