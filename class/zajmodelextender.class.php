...
abstract class zajModelExtender {
	 ...
	 */
	private function __construct(zajModel $parent){ $this->parent = $parent; }
	 ...
	 */
	public static function extend(string $parentmodel, string|bool $known_as = false, string|bool $parentmodel_source_file = false) : bool {
	 ...
	 **/
	public static function extension_of() : string {
	...
	public static function extension() : ?string {
		$class_name = get_called_class();
		return is_array(zajModel::${'extensions'}) && array_key_exists($class_name, zajModel::${'extensions'}) ? zajModel::${'extensions'}[$class_name] : null;
	}
	 ...
	 * @param int|string|null $id Id's are automatically generated by default, but you can force one here. Once created, id's cannot be changed.
	 ...
	 */
	public static function create(int|string|null $id = null, bool|zajModel|zajModelExtender $parent_object = false) : zajModelExtender {
		$class_name = get_called_class();
		// get my extension
			/* @var zajModelExtender $class_name */
