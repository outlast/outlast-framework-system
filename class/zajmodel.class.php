...
abstract class zajModel {
	 ...
	 *
	 * @param string $class_name The name of child class (model class). You should omit this when calling the method as it is automatically added.
	 ...
	 */
	protected static function __model($class_name, $fields){
	 ...
	 */
	protected static function __field($class_name, $field_name){
	 ...
	 */
	private static function create($class_name){
		// call event
		...
		// do i have any extenders?
			$ext = $class_name::extension();
			if($ext) $new_object = $ext::create($new_object);
	 ...
	 *
	 * @param string $field_name1 The first parameter to set.
	 * @param string $field_name2 The second parameter to set.
	 * @param string $field_name3 The third parameter to set...etc...
	 * @return zajModel Returns me to allow chaining.
	 **/
	 ...
	 * @return zajObject|boolean Returns the chainable object if successful, false if beforeSave prevented it.
	 */	
	 ...
	 * @return Returns the value returned by the event method.
	 ...
	 * @param string $id. The id of the object.
	 * @return zajObject Returns the object.
	 * @ignore
