<?php
/**
 * Useful for fetching information about the user's mobile device. Api is same as mobile detect class.
 * @link https://github.com/serbanghita/Mobile-Detect/wiki/Code-examples
 * @package Library
 **/

class zajlib_mobile extends zajLibExtension {

	/**
	 * My mobile detector instance.
	...
	function __construct(&$zajlib, $system_library){
		...
		// create my Mobile_Detect instance
	...
	public static function __callStatic($name, $arguments){
		return call_user_func_array("Mobile_Detect::$name", $arguments);
	}
	...
	public function __set($name, $value){
		return $this->detector->$name = $value;
	}
