<?php
	...
	class zajlib_dom extends zajLibExtension {
		...
		function fetch($file, $convert_to_lowercase = true) {
			...
			if (!$this->ofw->url->valid($file)) {
				$contents = $this->ofw->template->show($file, false, true);
			} else {
	 ...
	 * Updated: https://github.com/Kub-AT/php-simple-html-dom-parser/
	 *
