 ...
 *
 * 	 Provides easy extension top medium editor buttons
 */
define('system/js/ext/medium-editor/medium-custom-buttons', ["system/js/ext/medium-editor/medium-editor.min"], function (MediumEditor) {
	var MediumButton = function (options) {
