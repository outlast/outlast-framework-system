 ...
 **/
	...
	zaj.activateHandlers = function($parent){
		 ...
		 * @attr data-toggle-selector A selector which determines the destination DOM element (default: this)
		...
		$parent.find('[data-toggle-value]').each(function(){
			var $el =  $(this);
			var selector = ($el.data('toggle-selector'))?($el.data('toggle-selector')):$el;
